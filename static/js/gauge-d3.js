...
var barWidth, chart, chartInset, degToRad, repaintGauge,
  ...
  */
  ...
  // Create SVG element
  svg = el.append('svg').attr('width', width + margin.left + margin.right).attr('height', height/2 + margin.top );

  // Add layer for the panel
  chart = svg.append('g').attr('transform', "translate(" + (width / 2 + margin.left) + ", " + (height / 2) + ")");
